        ...
        if states["status"] == "inCity":
            ...
            if states["multiCharacterMode"]:
                if sum(states["multiCharacterModeState"]) == 0:
                    ...
                    if(config["characters"][states["currentCharacter"]]["una"]
                    ):
                        doUna()
                        print("doing una's dailies on : {}".format(states["currentCharacter"]))
                        print("una's dailies done on : {}".format(states["currentCharacter"]))
                    else:
                        print("una's not enabled on this character")
            ...
            pydirectinput.click(button=config["move"])
            sleep(200, 300)
            pydirectinput.press(config["bigPot"])
            sleep(200, 300)
            # doFloor3Portal()
...
def enterChaos():
    ...
    if config["shortcutEnterChaos"] == True:
        ...
        while True:
            ...
            # mouseMoveTo(x=1444, y=307)
            # sleep(500, 600)
            # pydirectinput.click(x=1444, y=307, button="left")
            # sleep(500, 600)
            # mouseMoveTo(x=1444, y=307)
            # sleep(500, 600)
            # pydirectinput.click(x=1444, y=307, button="left")
            ...
            chaosTabPosition = {
                ...
                # south vern
                1415: [[1253, 307], [524, 400]],
                1445: [[1253, 307], [524, 455]],
                1475: [[1253, 307], [524, 505]],
                1490: [[1253, 307], [524, 555]],
                1520: [[1253, 307], [524, 605]],
                1540: [[1253, 307], [524, 662]],
                1560: [[1253, 307], [524, 715]],
                # elgacia
                1580: [[1358, 307], [524, 400]],
                1600: [[1358, 307], [524, 455]],
                # voldis
                1610: [[1357, 306], [524, 400]],
            }
            if _curr["ilvl-aor"] > 1600:
                mouseMoveTo(x=1481, y=309)
                sleep(500, 600)
                pydirectinput.click(x=1481, y=309, button="left")
                sleep(500, 600)
                mouseMoveTo(x=1481, y=309)
                sleep(500, 600)
                pydirectinput.click(x=1481, y=309, button="left")
                ...
                mouseMoveTo(x=1444, y=309)
                sleep(500, 600)
                pydirectinput.click(x=1444, y=309, button="left")
                sleep(500, 600)
                mouseMoveTo(x=1444, y=309)
                sleep(500, 600)
                pydirectinput.click(x=1444, y=309, button="left")
...
def printResult():
    ...
    """ with open('stats.txt', 'w') as f:
       f.write("Expensive potions used: " + states["expensivePotCount"]) """
...
def waitForLoading():
    ...
    while True:
        ...
        if currentTime - blackScreenStartTime > config["blackScreenTimeLimit"]:
            ...
            # print("Current time - blackscreen:" + (currentTime - blackScreenStartTime) )
            # print("Limit:" + states["blackScreenTimeLimit"])
            # print("")
            print("alt f4")
            pydirectinput.keyDown("alt")
            sleep(350, 400)
...
def healthCheck():
    ...
    if r1 < 30 or r2 < 30 or r3 < 30:
        ...
        if states["status"] == "floor3":
            pydirectinput.press(config["bigPot"])
            states["expensivePotCount"] = states["expensivePotCount"] + 1
            return
...
def doUna():
    sleep(1000, 2000)
    print("accepting una dailies")
    doUna = acceptUnaDaily()
    sleep(1500, 1600)
    if doUna == False:
        return
    sleep(500, 600)
    ...
    mouseMoveTo(x=1706, y=429)
    sleep(1500, 1600)
    pydirectinput.click(x=1706, y=429, button="left")
    sleep(1500, 1600)
    mouseMoveTo(x=1706, y=429)
    sleep(1500, 1600)
    pydirectinput.click(x=1706, y=429, button="left")
    ...
    # unaClick = pyautogui.locateCenterOnScreen(
    #     "./screenshots/unaComplete.png",
    #     confidence=0.75,
    #     region=config["regions"]["center"],
    # )
    ...
    mouseMoveTo(x=266, y=693)
    sleep(1500, 1600)
    pydirectinput.click(x=266, y=693, button="left")
    sleep(1500, 1600)
    mouseMoveTo(x=266, y=693)
    sleep(1500, 1600)
    pydirectinput.click(x=266, y=693, button="left")
...
def doMokokoNight():
    ...
    sleep(2000, 3000)
    spamG(10000)
    print("walking mokoko night market")

    # first npc
    walkWithAlt(467, 824, 2500)
    spamG(2000)
    sleep(5000, 7000)

    # second npc
    walkWithAlt(1115, 750, 2500)
    spamG(2000)
    sleep(5000, 7000)

    # second npc
    walkWithAlt(1339, 825, 2500)
    spamG(2000)
    sleep(5000, 7000)
    # sleep(1500, 1600)

    # walking back to turn in
    walkWithAlt(961, 268, 3500)
    walkWithAlt(925, 240, 2500)
    spamG(10000)
    sleep(1500, 1600)
    print("mokoko night market daily done")
    sleep(1500, 1600)
